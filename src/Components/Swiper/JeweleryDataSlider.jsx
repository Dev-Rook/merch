...
const JeweleryDataSlider = () => {
  ...
  return (
    <div className={Styles.Slider_Container}>
      <h3 className={Styles.Slider_Title}>Jewelery</h3>
      <Swiper
        speed={1000}
        // spaceBetween={10}
          ...
          data.map((value) => {
            return (
              <SwiperSlide key={value?.id}>
                <Link onClick={scrollUp} to={"/Jewelery Products/" + value.id}>
...
export default JeweleryDataSlider;
